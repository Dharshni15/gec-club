...
const OfficeBearers = () => {
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 mb-12 slide-up">
            <h2 className="text-4xl font-bold text-foreground">Faculty Advisors</h2>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      <h3 className="text-2xl font-bold text-foreground mb-1">{advisor.name}</h3>
                      <p className="text-primary font-semibold mb-1">{advisor.position}</p>
                      <p className="text-muted-foreground mb-3">{advisor.department}</p>
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 mb-12 fade-in">
            <h2 className="text-4xl font-bold text-foreground">Secretaries</h2>
 ...
 {/* Treasurer */}
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 mb-12 fade-in">
            <h2 className="text-4xl font-bold text-foreground">Treasurer</h2>
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 mb-12 fade-in">
            <h2 className="text-4xl font-bold text-foreground">Joint Secretaries</h2>
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 mb-12 fade-in">
            <h2 className="text-4xl font-bold text-foreground">Joint Treasurer</h2>
            ...
            {EventOrganizing.map((coordinator, index) => (
              <Card key={index} className={`hover-lift border-0 card-gradient ${index % 2 === 0 ? 'scale-in' : 'slide-up'}`}>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground text-xs mb-3">{coordinator.year}</p>
                 </CardContent>
              </Card>
            ))}
          </div>
